...
public class CalculatorServiceImpl implements CalculatorService {
    ...
    public List<LoanOfferDto> getLoanOffers(LoanStatementRequestDto loanStatementRequestDTO) {
        ...
        List<LoanOfferDto> listLoanOfferDTO = Stream.of(
                        getAvailableOfferDTO(1L, true, true, loanStatementRequestDTO),
                        getAvailableOfferDTO(2L, true, false, loanStatementRequestDTO),
                        getAvailableOfferDTO(3L, false, true, loanStatementRequestDTO),
                        getAvailableOfferDTO(4L, false, false, loanStatementRequestDTO))
    ...
    private LoanOfferDto getAvailableOfferDTO(Long applicationId, boolean isInsuranceEnabled, boolean isSalaryClient, LoanStatementRequestDto loanStatementRequestDTO) {
        log.info("START CREATED LOAN OFFER");
